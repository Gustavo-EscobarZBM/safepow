...
| SP2 | Spec **escrito em 2026-09-24, aguardando revisão do usuário** (levantamento feito: U1–U5). Etapas 2.1 auditoria → 2.2 justificativa/aprovações → 2.3 correção retroativa → 2.4 motor | [SP2](2026-09-24-sp2-auditoria-aprovacoes-motor-design.md) | — | Mudança em relação ao mestre: auditoria por **trigger + eventos explícitos** (U4, substitui A7); `BaseCatalogService` adiado para o SP4 (regra dos três) |
| SP3 | Não iniciado | — | — | |
| SP4 | Não iniciado | — | — | |
| SP5 | Não iniciado | — | — | |
| SP6 | Não iniciado | — | — | |
