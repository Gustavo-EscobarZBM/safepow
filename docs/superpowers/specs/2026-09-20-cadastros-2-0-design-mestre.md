...
| SP1 | Etapa 1.1 (harness + F5/F16/F18) **concluída e mesclada em `main` em 2026-09-21**; etapa 1.2 é a próxima (plano em elaboração). F18: usuário decidiu em 2026-09-21 — migration `NULLIF` entra como primeira tarefa da etapa 1.2. | [SP1](2026-09-20-sp1-fundacao-de-dados-design.md) | 1.1: [plano](../plans/2026-09-20-sp1-etapa-1-1-harness-integracao.md) (5 tarefas, executado). 1.2 (inclui a migration do F18): em elaboração. 1.3, 1.4: planos ainda não escritos (1 plano por etapa: 1.1 harness → 1.2 valor/histórico + F18 → 1.3 ciclo de vida/busca → 1.4 sync/SQLite) | Baselines atuais: backend 17 suítes/106 testes unitários, 14 testes de integração, tsc limpo. Flutter em `C:\flutter\bin` (fora do PATH). Cada etapa seguinte só ganha plano depois de a anterior fechar |
| SP2 | Não iniciado | — | — | |
| SP3 | Não iniciado | — | — | |
| SP4 | Não iniciado | — | — | |
| SP5 | Não iniciado | — | — | |
