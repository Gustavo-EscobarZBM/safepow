...
| SP1 | Etapa 1.1 **concluída e mesclada em `main` em 2026-09-21**. Etapa 1.2 dividida em sub-etapas (1.2.1 F18+hardening → 1.2.2 migrations de valor/histórico → 1.2.3 backend → 1.2.4 web); **sub-etapa 1.2.1 concluída**; sub-etapa 1.2.2 é a próxima (ainda não planejada). | [SP1](2026-09-20-sp1-fundacao-de-dados-design.md) | 1.1: [plano](../plans/2026-09-20-sp1-etapa-1-1-harness-integracao.md) (executado). 1.2.1: [plano](../plans/2026-09-21-sp1-etapa-1-2-1-f18-e-hardening.md) (3 tarefas, executado). 1.2.2-1.2.4, 1.3, 1.4: planos ainda não escritos | Baselines atuais: backend 18 suítes/110 testes unitários, 17 testes de integração (`npm run test:int`), tsc limpo. Flutter em `C:\flutter\bin` (fora do PATH). Cada sub-etapa seguinte só ganha plano depois de a anterior fechar |
| SP2 | Não iniciado | — | — | |
| SP3 | Não iniciado | — | — | |
| SP4 | Não iniciado | — | — | |
| SP5 | Não iniciado | — | — | |
