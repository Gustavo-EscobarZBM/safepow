...
// canConfigure = gerente. O funcionário designado como conferente só vê e confirma as
// pendências: configurações e lista de usuários são endpoints exclusivos do gerente no
// backend (403 para o conferente), então nem são requisitados nesse modo.
export function ConferenciasClient({ canConfigure }: { canConfigure: boolean }) {
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          {canConfigure
            ...
            : 'Confirme as perdas registradas pelos funcionários.'}
        </p>
      </div>
