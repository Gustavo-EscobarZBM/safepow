...
// Paleta e tipografia extraídas da identidade oficial da marca SAFEPOW
// (documento de marca no Canva — página "cores"/"fonte"): #032727 primária,
// #435757 secundária, branco, Chunk Five para títulos e Quicksand para corpo.
// Os valores viram variáveis CSS em globals.css; aqui só mapeamos para as
// classes que os componentes shadcn/ui geram (bg-primary, text-muted-foreground etc.).
const config: Config = {
  darkMode: ['class'],
